...
ALTER TABLE public.schema_migration OWNER TO tjasaspes;

--
-- Name: users; Type: TABLE; Schema: public; Owner: tjasaspes
--
...
ALTER TABLE public.users OWNER TO tjasaspes;

--
-- Name: users_id_seq; Type: SEQUENCE; Schema: public; Owner: tjasaspes
--
...
ALTER SEQUENCE public.users_id_seq OWNER TO tjasaspes;

--
-- Name: users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: tjasaspes
--
...
--
-- Name: schema_migration schema_migration_pkey; Type: CONSTRAINT; Schema: public; Owner: tjasaspes
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: tjasaspes
--
...
--
-- Name: reservations_email_idx; Type: INDEX; Schema: public; Owner: tjasaspes
--
...
--
-- Name: reservations_last_name_idx; Type: INDEX; Schema: public; Owner: tjasaspes
--
...
--
-- Name: room_restrictions_reservation_id_idx; Type: INDEX; Schema: public; Owner: tjasaspes
--
...
--
-- Name: room_restrictions_room_id_idx; Type: INDEX; Schema: public; Owner: tjasaspes
--
...
--
-- Name: room_restrictions_start_date_end_date_idx; Type: INDEX; Schema: public; Owner: tjasaspes
--
...
--
-- Name: schema_migration_version_idx; Type: INDEX; Schema: public; Owner: tjasaspes
--
...
--
-- Name: users_email_idx; Type: INDEX; Schema: public; Owner: tjasaspes
--
...
--
-- Name: reservations reservations_rooms_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: tjasaspes
--
...
--
-- Name: room_restrictions room_restrictions_reservations_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: tjasaspes
--
...
--
-- Name: room_restrictions room_restrictions_restrictions_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: tjasaspes
--
...
--
-- Name: room_restrictions room_restrictions_rooms_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: tjasaspes
--
